...
class CodeErrorGUI:
    ...
    def create_input_gui(self):
        ...
        root = tk.Tk()
        root.title("🚀 Tony AI - Code Fixer Pro")
        ...
        tk.Label(header_frame, text="🚀 Tony AI Code Fixer", 
    ...
    def show_result_gui(self, fixed_code: str, original_language: str = ""):
        ...
        root = tk.Tk()
        root.title(f"✅ {original_language.upper()} Code Fixed Successfully - Tony AI")
...
async def fix_code_error() -> str:
    ...
    try:
        ...
        processing = tk.Tk()
        processing.title("🔄 Processing - Tony AI")
        ...
        tk.Label(processing_frame, text="🔍 Tony AI is fixing your code...",
