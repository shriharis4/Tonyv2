...
@function_tool()
async def web_scraper(query: str, url: str) -> str:
    """
    Analyzes webpage content based on user query and website URL.
    It scrapes the webpage content and uses Groq AI to analyze the content in relation to the user's query.
    
    Args:
        query (str): The question or topic to analyze from the webpage content
        url (str): The website URL to scrape and analyze
